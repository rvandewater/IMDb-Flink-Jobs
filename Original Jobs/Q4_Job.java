...
//        String DataDirectory ="C:\\Users\\Robin\\Documents\\experimentdata\\IMDB\\";
        ...
        //Join tables
        JoinOperator.ProjectJoin<Tuple9<String, String, String, String, String, Integer, String, String, String>, Tuple3<String, Float, Integer>, Tuple> join = title_basics_filtered
                ...
                .projectSecond(1, 2);//.returns(Types.TUPLE(Types.STRING, Types.OBJECT_ARRAY(Types.STRING)));


//         collected = join.collect();
//        collected.forEach(System.out::println);
        JoinOperator.ProjectJoin<Tuple9<String, String, String, String, String, Integer, String, String, String>, Tuple3<String, Float, Integer>, Tuple> query = join;
